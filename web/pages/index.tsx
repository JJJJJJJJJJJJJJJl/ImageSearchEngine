    ...
    return (
        <Layout>
            <div className="flex justify-between w-3/4 mx-auto">
                <label className="bg-pink-200 font-light text-slate-700 px-4 py-3 hover:cursor-pointer">
                ...
                */}
                <Link href="/search">
                    <button onClick={send_images} className="px-4 py-3 font-light text-slate-700 bg-pink-200">Submit</button>
                </Link>
            </div>
